...
from classes.indicators.MiscIndicators import MovingAverages, inject_ichimoku
from classes.indicators.MomentumIndicators import RSI, MACD
from classes.indicators.VolatilityIndicators import Bollinger, Stochastic
...
class EnhancedDataframe:
    ...
    def __post_init__(self):
        self.populate_dataframe(self.dataframe)
